      ...
      >
        ...
        <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-xl border border-slate-200 dark:border-slate-700 p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 rounded-xl transition-all hover:shadow-lg hover:shadow-blue-200 dark:hover:shadow-blue-900"
            >
        ...
        <p className="text-center text-xs text-slate-400 mt-6">
          Government of India · Secure Portal · <span className="text-green-500">🔒 SSL Encrypted</span>
        </p>
      </motion.div>
    </div>
  )
